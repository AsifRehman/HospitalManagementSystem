...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2017 at 02:35 PM
...
(1001, '1234567', 'malaria tab', '500mg', 'Tablets', 47, 0, 50, 100, '11/04/2017');
...
INSERT INTO `outpatpayments` (`PID`, `PatientNO`, `Patient_Name`, `drug`, `Consult_Fee`, `FP`, `Lab`, `MCH`, `Others`, `TotalBill`, `Paid`, `Balance`, `PaymentDate`) VALUES
(1, '1001', 'BENSON MAWIRA MATHINJA', 200, 100, 0, 0, 0, 0, 300, 300, 0, '2017-11-04'),
(2, '1001', 'BENSON MAWIRA MATHINJA', 200, 100, 0, 0, 0, 0, 300, 300, 0, '2017-11-09'),
(3, '1001', 'BENSON MAWIRA MATHINJA', 200, 100, 0, 200, 0, 0, 500, 500, 0, '2017-11-09');
