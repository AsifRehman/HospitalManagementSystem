...
Public Class MCHWklyReport
    Dim Y As Integer
    Private Sub MCHWklyReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Count()
        ...
        Try
            ...
            'stt = "NF"
            ' connectDB()
            sql = "Select COUNT(PatientNo) as TNO FROM imm_vaccine WHERE Entry_Date BETWEEN '" & Me.DateTimePicker1.Value.ToString("dd-MMM-yy") & "' AND  '" & Me.DateTimePicker2.Value.ToString("dd-MMM-yy") & "' ORDER By Entry_Date"
    ...
    Private Sub LoadItemstoDatagrid()
        ...
        Try
            ...
            sql = "SELECT PatientNo,PatientName,Telephone,Age,Vaccine_Name,Entry_Date FROM imm_vaccine WHERE Entry_Date BETWEEN '" & Me.DateTimePicker1.Value.ToString("dd-MMM-yy") & "' AND  '" & Me.DateTimePicker2.Value.ToString("dd-MMM-yy") & "' ORDER By Entry_Date"
            ...
            Do While dr.Read = True
                dgw.Rows.Add(dr("PatientNO"), dr("PatientName"), dr("Telephone"), dr("Age"), dr("Vaccine_Name"), dr("Entry_Date"))
                y += 17
